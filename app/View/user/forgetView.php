...
<?php
    class ForgetView
{
    public function displayPassword($password)
    {
        echo "from foegetView";
        //echo "<tr><td><h1> your password is <strong>$password<strong><br> </td></tr>
        //<tr><td>please use this to login 
        //</h1><br><br><a href='../../../public/assets/html/user/login.html'>Login</a></td></tr>";
