  ...
  <dl id="browse">
    ...
    <dd style="font-size:16px;"><p style="margin-top:0px;font-weight:bold;padding:3px 10px;color:white;font-size:16px" onclick="userRedirect()" id="redirect"></p></dd>
        ...
        <center>
            ...
            echo "<br>";?>
        <form action="../../../../app/Controller/authordash/authordash.php" method="post" enctype="multipart/form-data" autocomplete="off" onsubmit="return validateForm()" id="donoting">
        <table id="tables">
