...
<table>
    ...
    foreach($books as $book)
    {
      ...
      $url="../../Controller/authordash/DeleteSelectedBook.php?id=".$book['bookid'];
      echo "<td><a href=$url><button style='background-color:red;color:white;border:0px'>Delete Book</button></a></td>";
      echo "</tr>";
      $i++;
    }
    echo "</table>";
