   ...
   nav 
   {
    ...
    <body>
        ...
        <center id="register">
          ...
          <table>
            <form action="../../../../../book_store/app/Controller/user/register.php" method="POST" autocomplete="off" onsubmit="return validateForm()" >
                <tr><td><?php
                $msg=$_GET['msg']??" ";
               ...
               <tr><td><input type="text" name="name" placeholder="Author name" id="names"><br></td></tr>
                ...
                <tr><td><input type="text" name="address" placeholder="Enter your address" id="address" required><br></td></tr>
